...
const laboratorioItems = [
  ...
  { label: 'Doctores/as', icon: UserRound, href: '/laboratorio/doctores', activePrefix: '/laboratorio' },
  { label: 'Tarifas', icon: DollarSign, href: '/laboratorio/tarifas', activePrefix: '/laboratorio' },
  { label: 'Máquinas', icon: Cog, href: '/laboratorio/maquinas', activePrefix: '/laboratorio' },
  ...
  { label: 'Transportes', icon: TruckIcon, href: '/laboratorio/transportes', activePrefix: '/laboratorio' },
  { label: 'Etiquetas de trabajos', icon: Tag, href: '/laboratorio/etiquetas', activePrefix: '/laboratorio' },
  { label: 'Incidencias y calidad', icon: AlertTriangle, href: '/laboratorio/incidencias', activePrefix: '/laboratorio' },
  { label: 'Implantes', icon: Smile, href: '/laboratorio/implantes', activePrefix: '/laboratorio' },
